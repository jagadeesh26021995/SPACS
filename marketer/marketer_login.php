...
<?php
    ...
    if (isset($_POST['email'])) {
        ...
        $query    = "SELECT * FROM `marketer` WHERE email='$email'
        ...
        if ($rows == 1) {
            ...
            header("Location: marketer_welcome.php");
        }
         else {
            echo "<div class='form'>
...
?>
    <form class="form" method="post" name="login">
        ...
        <input type="text" class="login-input" name="email" placeholder="email_id" autofocus="true"/><br>
