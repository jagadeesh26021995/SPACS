...
if(isset($_POST['save']))
{
    $username = $_POST['username'];
     ...
     $sql="INSERT INTO programmer(username,password,email,contactno,gender,address)VALUES('$username','".md5($password)."','$email','$contactno','$gender','$address')";
...
::placeholder {
  ...
  <body>
	  ...
	  $que=mysqli_query($con,"SELECT * FROM programmer");
	  while($row=mysqli_fetch_array($que))
		  ...
		  ?>
	  <label>Add or Delete programmer</label>
		  <hr>
	<form method="post" action="">
        
	<label>Name:&ensp;&emsp;</label>
		<input type="text" name="username" size="30"placeholder="&nbsp;Programmer Name..."><br><br>
		

		<label>Password:&nbsp;</label>
		<input type="password" name="password" size="30"placeholder="&nbsp;Programmer Password..." required><br><br>
...
  <input type="radio" name="gender" value="Others"><h style="font-size:0.8em;">&nbsp;Others</h><br><br>
		...
		<input type="text" name="email" size="30" placeholder="&nbsp;Programmer Email.."required><br><br>
		
		<label>Contact:&ensp;&emsp;</label>
		<input type="text" name="contactno" size="30"placeholder="&nbsp;Programmer Contact.."required><br><br>
